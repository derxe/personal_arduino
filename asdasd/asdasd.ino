...
void setup() {
  ...
  Wire.write(0x00);
  Wire.endTransmission();
  for (RateCalibrationNumber=0; RateCalibrationNumber<1; RateCalibrationNumber ++) {
    gyro_signals();
  ...
  RateCalibrationRoll = -0.06;
  RateCalibrationPitch = -0.03;
  RateCalibrationYaw = 0.34;

  Serial.print("RateCalibrationRoll:"); Serial.print(RateCalibrationRoll); Serial.print(" ");
  Serial.print("RateCalibrationPitch:"); Serial.print(RateCalibrationPitch); Serial.print(" ");
