...
void SoftwareWire::begin(uint8_t address) {
    (void)address; // unused, only here to satisfy TwoWire interface
    begin();
}
...
uint8_t SoftwareWire::requestFrom2(uint8_t address, uint8_t size, boolean sendStop)
{
...
boolean SoftwareWire::i2c_start(void)
{
  ...
  {
    Serial.println("sda 0 and scl 0");
    return(false);
  }
  else
  {
